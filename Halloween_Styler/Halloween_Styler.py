...
class HalloweenStyler:
    ...
    def INPUT_TYPES(self):
        ...
        # Construct 'Halloween_Styles.json' path
        file_path = os.path.join(p, 'Halloween_Styles.json')
...
NODE_CLASS_MAPPINGS = {
    "HalloweenStyler": HalloweenStyler,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "HalloweenStyler": "Halloween Styler",
}