...
class AestheticStyler:
    ...
    def INPUT_TYPES(self):
        ...
        # Construct 'Aesthetic_Styles.json' path
        file_path = os.path.join(p, 'Aesthetic_Styles.json')
...
NODE_CLASS_MAPPINGS = {
    "AestheticStyler": AestheticStyler,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "AestheticStyler": "Aesthetic Styler",
}