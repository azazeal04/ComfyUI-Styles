...
class TravelPosterStyler:
    ...
    def INPUT_TYPES(self):
        ...
        # Construct 'Travel_Poster_styles.json' path
        file_path = os.path.join(p, 'Travel_Poster_Styles.json')
...
NODE_CLASS_MAPPINGS = {
    "TravelPosterStyler": TravelPosterStyler,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "TravelPosterStyler": "Travel Poster Styler",
}